...
# Existing helper functions (get_row_count, get_last_update, index, node_status, get_movies) remain the same...
...
def get_movies():
    # Read logic remains the same (always auto-commit read operation)
